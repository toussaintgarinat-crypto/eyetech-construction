    ...
    <aside style={styles.sidebar}>
      ...
      <div style={{ padding: '0 14px 12px', display: 'flex', gap: '6px', flexWrap: 'wrap' }}>
        {[
          ...
          { label: 'BuildingScan', short: 'BS', color: '#7c3aed', port: 5172, current: true },
          ...
          <a
            ...
            style={{
              ...
              background: app.current ? 'rgba(124,58,237,0.15)' : 'transparent',
              border: `1px solid ${app.current ? '#7c3aed' : '#334155'}`,
              textDecoration: 'none', fontSize: '11px',
              color: app.current ? '#7c3aed' : '#64748b',
